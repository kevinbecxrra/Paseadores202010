...
public class PagoPaseadorPaseoIT {
    
    private static final String COLLECTION = "PagoPaseadorPaseo-Tests.postman_collection";
    ...
    public static WebArchive createDeployment() {
        return ShrinkWrap.create(WebArchive.class, "s2_paseadores-api.war")//War del modulo api
                ...
                .addPackage(PagoPaseadorDTO.class.getPackage()) //No importa cual dto usar, lo importante es agregar el paquete.
